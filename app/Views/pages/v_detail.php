        ...
        <div class="flex flex-col lg:flex-row gap-8 lg:gap-12">
            ...
            <div class="w-full lg:w-2/5 flex flex-col gap-4 items-center lg:items-start">
                ...
                <div id="zoom-container"
                    class="w-full aspect-square max-w-[500px] border rounded-lg overflow-hidden shadow-lg bg-gray-50 relative">
                    <img id="main-image"
                ...
                <div class="flex gap-3 overflow-x-auto lg:flex-wrap lg:overflow-visible w-full max-w-[500px]">
                    <?php if (!empty($row->additionalimages)) : ?>
                        <?php foreach (json_decode($row->additionalimages) as $index => $image) : ?>
                            <div class="w-20 h-20 border <?= $index === 0 ? 'border-[#2F5D50]' : 'border-gray-300' ?> rounded-md p-1 cursor-pointer hover:border-[#2F5D50] transition-colors bg-gray-50 flex-shrink-0"
