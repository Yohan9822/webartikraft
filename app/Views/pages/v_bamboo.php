...
<?php else: ?>
    <div class="w-full h-full flex flex-col">
        <img data-src="<?= base_url('public/images/home/10.jpg') ?>" alt="gambar bamboo" class="lazy w-full h-[600px] object-cover">
        ...
        <div class="grid grid-cols-1 md:grid-cols-5">
            <div class="md:col-span-2">
                <img data-src="<?= base_url('public/images/home/11.jpg') ?>" alt="gambar bamboo" class="lazy w-full h-[500px] object-cover">
            </div>
            <div class="md:col-span-3">
                <img data-src="<?= base_url('public/images/home/12.jpg') ?>" alt="gambar bamboo" class="lazy w-full h-[500px] object-cover">
            </div>
        </div>
    </div>
        ...
        <div class="flex flex-nowrap overflow-x-auto gap-4 py-4">
            <?php for ($s = 0; $s <= 10; $s++): ?>
                <div class="w-full md:w-1/3 flex flex-col flex-shrink-0 items-start justify-start text-left">
                    <img data-src="<?= base_url('public/images/home/3.jpg') ?>" alt="Produk" class="lazy w-full h-[450px] object-cover mb-3" />
                </div>
                <div class="w-full md:w-1/3 flex flex-col flex-shrink-0 items-start justify-start text-left">
                    <img data-src="<?= base_url('public/images/home/4.png') ?>" alt="Produk" class="lazy w-full h-[450px] object-cover mb-3" />
                </div>
                <div class="w-full md:w-1/3 flex flex-col flex-shrink-0 items-start justify-start text-left">
                    <img data-src="<?= base_url('public/images/home/5.jpg') ?>" alt="Produk" class="lazy w-full h-[450px] object-cover mb-3" />
                </div>
            <?php endfor; ?>
        </div>
    </section>
    <div class="w-full h-full mb-6">
        <div class="grid grid-cols-8 gap-4">
            <div class="col-span-8 md:col-span-4">
                <img data-src="<?= base_url('public/images/home/13.jpg') ?>" alt="gambar bamboo" class="lazy w-full h-[400px] object-cover">
            </div>
            <div class="col-span-4 md:col-span-2">
                <img data-src="<?= base_url('public/images/home/14.jpg') ?>" alt="gambar bamboo" class="lazy w-full h-[400px] object-cover">
            </div>
            <div class="col-span-4 md:col-span-2">
                <img data-src="<?= base_url('public/images/home/15.jpg') ?>" alt="gambar bamboo" class="lazy w-full h-[400px] object-cover">
            </div>
        </div>
    </div>
